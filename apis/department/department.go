...
func ListDepartMentSub(ctx *ding.App, payload []byte) (resp []byte, err error) {
	return ctx.Client.HTTPPost(apiListGetDepartmentSub, payload, ding.DefaultPostDecodeStr)
}
...
func GetDepartment(ctx *ding.App, payload []byte) (resp []byte, err error) {
	return ctx.Client.HTTPPost(apiGetGetDepartment, payload, ding.DefaultPostDecodeStr)
}
...
func ListDepartmentSubID(ctx *ding.App, payload []byte) (resp []byte, err error) {
	return ctx.Client.HTTPPost(apiListDepartmentSubID, payload, ding.DefaultPostDecodeStr)
}
